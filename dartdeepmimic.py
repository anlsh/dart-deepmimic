...
class DartDeepMimicArgParse(argparse.ArgumentParser):
    ...
    def get_env(self):
        ...
        return DartDeepMimicEnv(self.args.control_skel_path,
                                self.args.asf_path,
                                self.args.ref_motion_path,
                                self.args.state_mode,
                                self.args.action_mode,
                                self.args.p_gain, self.args.d_gain,
                                self.args.pos_init_noise,
                                self.args.vel_init_noise,
                                self.args.reward_cutoff,
                                self.args.pos_weight,
                                self.args.pos_inner_weight,
                                self.args.vel_weight,
                                self.args.vel_inner_weight,
                                self.args.ee_weight,
                                self.args.ee_inner_weight,
                                self.args.com_weight,
                                self.args.com_inner_weight,
                                self.args.max_torque,
                                self.args.default_damping,
                                self.args.default_spring,
                                self.args.visualize,
                                self.args.simsteps_per_dataframe,
